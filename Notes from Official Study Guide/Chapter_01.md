...
* common goal of governance is to maintain business processes while striving toward growth and resiliency.
...
* Testing backups, validating data integrity, deploying security solutions, and managing data storage based on classification
...
* used to assign responsibilities, define roles, specify audit requirements, outline enforcement processes, indicate compliance requirements, and define acceptable risk levels
* assigning tasks and responsibilities to a role (not a person)

#### Categories of Security Policies

##### regulatory

whenever industry or legal standards are applicable to your organization
...
provide information or knowledge about a specific subject, such as company goals
...
offers recommendations on how standards and baselines are implemented and serves as
an operational guide for both security professionals and users
...
Use asset valuation results and attempts to identify threats to the valuable assets

#### Focused on Attackers

identify potential attackers and can identify the threats they represent based on the attacker’s goals.
...
Any activity that requires greater privileges than of a standard user account or process.
...
(1 to 100 scale, 100 being most severe)
